(function (global, factory) {
  ...
  function isReservedTag(key) {
    var makeMap = 'a,div,img,image,text,span,p,button.input,textarea,ul,li,table,td,h1,h2,h3,h4,h5,h6';
  ...
  function createElementVNode(vm, tag, data) {
    if (!data) data = {}; //生成vNode 要判断是否是原始标签还是自定义组件
  ...
  function createComponent(vm, tag, data, key, children, text, Ctor) {
    ...
    var component = vNode(tag, data, key, children, text);
    return component;
  }
